...
const TRANSFORMATION_STORIES=[
  {name:"Marcus T.",result:"Down 38 lbs",pkg:"HUSTLE",time:"90 days",visual:"fatloss",focus:"Fat loss, food discipline, weekly check-ins",quote:"I stopped guessing. Rod gave me the meals, the workouts, and the pressure to stay locked in when I wanted to freestyle."},
  ...
  {name:"DeShawn R.",result:"18 lbs lean mass added",pkg:"EMPIRE",time:"4 months",visual:"muscle",focus:"Muscle gain, trainer certification, business prep",quote:"Empire gave me more than workouts. I built my body, got certified, and learned how to talk to real clients."},
];
const REVIEWS=[
